...
open_page()
print(f'BRIHAN MUMBAI CITY in progress')
...
FIR_modules.district_selection('BRIHAN MUMBAI CITY', driver=driver)
...
if record == '':
    print(f'page not loaded for BRIHAN MUMBAI CITY')
    driver.quit()
...
if int(record) > 0:
    ...
    driver.quit()
    print(f'no records. BRIHAN MUMBAI CITY finished')
...
if int(record) > 50:
    ...
    driver.quit()
    print(f'BRIHAN MUMBAI CITY finished')
